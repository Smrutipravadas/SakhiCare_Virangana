...
// class ApiService {
//   static const String baseUrl = "http://172.10.0.188:8000";
...
class ApiService {
  static const String baseUrl = "http://10.160.178.152:8000";
  // Use laptop IP when testing on real phone
  ...
  static Future<void> savePeriod({
    ...
    if (response.statusCode != 200) {
      throw Exception("Failed to save period");
    }
  }
